...
import com.example.myapplication.Adapter.GridViewSuggestAdapter;
...
public class Level_1_GuessPicture extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < Common.user_submit_answer.length; i++) {
                    ...
                    if (result.equals(correct_answer)) {
                        ...
                        GridViewSuggestAdapter suggestAdapter = new GridViewSuggestAdapter
    ...
    private void setupList() {
        ...
        suggestAdapter = new GridViewSuggestAdapter
